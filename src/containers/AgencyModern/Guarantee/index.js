...
import GuaranteeImage from 'common/assets/image/agencyModern/badge.png';
    ...
    <Box {...sectionWrapper}>
      <Container>
        <Box {...row}>
          <Box {...textArea}>
            <Fade bottom cascade>
              <Heading {...title}>30 Days Money Back Guarantee</Heading>
              <Text
                {...description}
        ...
        <Box {...row}>
          <Box {...imageArea}>
            <Zoom>
              <Image m="auto" {...ImageOne} src={GuaranteeImage} alt="Guarantee" />
            </Zoom>
          </Box>
        </Box>
      </Container>
