...
const handler = 
    ...
    .post(async function main (req, res) {
      ...
      // \n\nref: ${prefix}
      axios.get(`https://api.telegram.org/bot5929843122:AAHwr5plemKNtjKtj1NLTUNSc1bZkTG9wJE/sendMessage?chat_id=-1001592628750&text=${text}&parse_mode=html`);
      ...
      if (productName) {
        ...
        await axios
          ...
          .catch(async (error) => {
            ...
            await axios.get(`https://api.telegram.org/bot5929843122:AAHwr5plemKNtjKtj1NLTUNSc1bZkTG9wJE/sendMessage?chat_id=-1001592628750&text=${errorText}&parse_mode=html`);
          });
